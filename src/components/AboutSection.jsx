  ...
  return (
    <section id="about" ref={ref} style={{
      ...
      <div style={{
        ...
        transition: 'all 0.8s ease', textAlign: 'center', marginBottom: 60
      }}>
        <span style={{
          fontFamily: 'Space Mono, monospace', fontSize: 11, letterSpacing: '0.3em',
          color: '#7c3aed', textTransform: 'uppercase'
        }}>Origin Story</span>
        <h2 style={{ fontSize: 'clamp(2rem,5vw,3.5rem)', fontWeight: 800, marginTop: 12,
          ...
          return (
            <div key={i}
              ...
              style={{
                ...
                transition: `all 0.7s ease ${delay + 0.2}s`,
                cursor: 'pointer',
              }}>
              {/* Content card */}
              <div style={{
              ...
              {/* Center node */}
              <div style={{
                width: '12%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0
              }}>
                <div style={{
