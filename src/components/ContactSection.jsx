  ...
  return (
    <section id="contact" ref={ref} style={{
      ...
      <div style={{
        ...
        transition: 'all 0.8s ease', textAlign: 'center', marginBottom: 70
      }}>
        <span style={{ fontFamily: 'Space Mono, monospace', fontSize: 11, letterSpacing: '0.3em', color: '#e879f9' }}>
          Control Room
        </span>
        <h2 style={{
          fontSize: 'clamp(2rem,5vw,3.5rem)', fontWeight: 800, marginTop: 12,
          background: 'linear-gradient(135deg,#fff,#f0abfc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'
        }}>Contact</h2>
        <p style={{
            ...
            return (
              <a key={c.label} href={c.href} target="_blank" rel="noreferrer"
                ...
                <div style={{
                  ...
                  transform: hovered === i ? 'translateY(-4px) scale(1.03)' : 'none',
